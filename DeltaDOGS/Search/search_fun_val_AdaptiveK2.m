function [y,indm]=search_fun_val_AdaptiveK2(x, inter_par,inter_Par,xi,tri)
...
% "" the search function we are using is
% -e/search_fun_val(x,inter_par,inter_Par,xi,tri)"
% calculates max {-e / p-y0e , -e / g_i} , i=1,...m
% this function is more smooth and does not go to inf in the vertices
[e,indm]=Uncertainty_quad(x,xi,tri);
[y, indm] = search_fun_val(x,inter_par,inter_Par,xi,tri); %calculates max {p-y0/e , g_i/e} , i=1,...m
y = -e/y;  
% calculates max {-e / p-y0e , -e / g_i} , i=1,...m
y=y/e;
